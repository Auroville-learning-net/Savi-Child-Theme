...
function ai1ec_post_type_init() {
	...
	if ( function_exists( 'ai1ec_initiate_constants' ) && defined( 'AI1EC_POST_TYPE' ) ) :
		...
		$labels = array(
			'name'               => Ai1ec_I18n::_x( 'Work Shops & Seminars', 'Custom post type name' ),
			'singular_name'      => Ai1ec_I18n::_x( 'Work Shop & Seminar', 'Custom post type name (singular)' ),
			'add_new'            => Ai1ec_I18n::__( 'Add New Work Shop & Seminar' ),
			'add_new_item'       => Ai1ec_I18n::__( 'Add New Work Shop & Seminar' ),
			'edit_item'          => Ai1ec_I18n::__( 'Edit Work Shop & Seminar' ),
			'new_item'           => Ai1ec_I18n::__( 'New Work Shop & Seminar' ),
			'view_item'          => Ai1ec_I18n::__( 'View Work Shop & Seminar' ),
			'search_items'       => Ai1ec_I18n::__( 'Search Work Shop & Seminar' ),
			'not_found'          => Ai1ec_I18n::__( 'No Work Shops & Seminars found' ),
			'not_found_in_trash' => Ai1ec_I18n::__( 'No Work Shops & Seminars found in Trash' ),
			'parent_item_colon'  => Ai1ec_I18n::__( 'Parent Work Shop & Seminar' ),
			'menu_name'          => Ai1ec_I18n::__( 'Work Shops & Seminars' ),
			'all_items'          => 'All Work Shops & Seminars',
		);
...
function savi_custom_add_menu_page(){
	add_menu_page( __( 'Enquires', 'savi' ), __( 'Enquires', 'savi' ), 'manage_options','main-menu_page', '','',32 );
}
...
function savi_custom_editor_add_menu_page(){
	add_menu_page( __( 'Enquires', 'savi' ), __( 'Enquires', 'savi' ), 'editor','main-menu_page', '','',32 );
}
