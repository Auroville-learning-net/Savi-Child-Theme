				...
				marker : {
					...
					events : {
						click: function( marker ){
						  ...
						  marker.setIcon( '<?php echo get_stylesheet_directory_uri(); ?>/images/red-marker.png' );
...
?>
		...
		<?php endif; ?>
			...
			<div class="et-place-content">
				...
				<?php if ( ( $et_coordinator_name = get_post_meta( get_the_ID(), 'unit_name', true ) ) && '' != $et_coordinator_name ) : ?>
                	<div class="av-unit-info"><?php echo esc_html( 'Coordinator Name:    '. $et_coordinator_name ); ?></div>
                <?php endif; ?>
                
                <?php if ( ( $et_coordinator_mail = get_post_meta( get_the_ID(), 'contact_email', true ) ) && '' != $et_coordinator_mail ) : ?>
                	<div class="av-unit-info"><?php echo esc_html('Coordinator Email:    '. $et_coordinator_mail ); ?></div>
                <?php endif; ?>
                
                <?php if ( ( $et_coordinator_number = get_post_meta( get_the_ID(), 'contact_number', true ) ) && '' != $et_coordinator_number ) : ?>
                	<div class="av-unit-info"><?php echo esc_html( 'Coordinator Phone:    '.$et_coordinator_number ); ?></div>
                <?php endif; ?>
