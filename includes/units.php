...
<?php } ?>
	<?php if ( 'false' == et_get_option( 'explorable_blog_style', 'false' ) ) { ?>
		...
		<tr>
		<td>Landphone : </td>
		<td><div class="unit_url"><?php echo get_post_meta( get_the_ID(), "landphone", true ); ?></div></td>
		</tr>
		<tr>
		<td>Unit Url : </td>
		<td><div class="unit_url"><?php echo get_post_meta( get_the_ID(), "unit_url", true ); ?></div></td>
		</tr>
		<tr>
		<td>Contact Name : </td>
		<td><div class="unit_url"><?php echo get_post_meta( get_the_ID(), "unit_name", true ); ?></div></td>
		</tr>
		<tr>
		<td>Contact Email : </td>
		<td><div class="unit_url"><?php echo get_post_meta( get_the_ID(), "contact_email", true ); ?></div></td>
		</tr>
		<tr>
		<td>Contact Number : </td>
		<td><div class="unit_url"><?php echo get_post_meta( get_the_ID(), "contact_number", true ); ?></div></td>
		</tr>
		</table>
	<?php } else { ?>
		<?php the_content( '' ); ?>
